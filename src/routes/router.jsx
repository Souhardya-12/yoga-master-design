...
export const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            },
            {
                path: "/class/:id",
                element: <SingleClass/>,
                loader: ({params}) => fetch(`https://yoga-master-server-bc4w.onrender.com/class/${params.id}`)
            }
        ]
    },
    {
        ...
        children: [
            ...
            },
            {
                path: "update-user/:id",
                element: <UpdateUser/>,
                loader: ({params}) => fetch(`https://yoga-master-server-bc4w.onrender.com/users/${params.id}`)
            }
        ]
    },
    {
